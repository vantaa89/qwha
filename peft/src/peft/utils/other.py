...
from ..import_utils import is_auto_gptq_available, is_torch_tpu_available, is_gptqmodel_available
...
def get_auto_gptq_quant_linear(gptq_quantization_config):
    ...
    """
    if gptq_quantization_config is not None and is_gptqmodel_available():
        ...
        AutoGPTQQuantLinear = hf_select_quant_linear(
            desc_act=desc_act,
    ...
    elif gptq_quantization_config is not None and is_auto_gptq_available():
