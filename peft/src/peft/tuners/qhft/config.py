...
@dataclass
class QHFTConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`QHFTModel`].

    Args:
        n_frequency (`int`):
            Num of learnable frequencies for the Hadamard Transform. 'n_frequency' is an integer that is
        ...
        scaling (`float`):
            ...
            across all NLU (GLUE) tasks.
        random_loc_seed (`int`):
            Seed for the random location of the frequencies, i.e., the spectral entry matrix.
        target_modules (`Union[list[str],str]`):
            List of module names or regex expression of the module names to replace with QHFT. For example, ['q',
        ...
        bias (`str`):
            Bias type for QHFT. Can be 'none', 'all' or 'qhft_only'.
        modules_to_save (`list[str]`):
            List of modules apart from QHFT layers to be set as trainable and saved in the final checkpoint. For
        ...
        init_weights (`bool`):
            The initialization of the QHFT weights. Set this to False if the spectrum are initialized to a standard
    ...
    n_frequency: int = field(
        ...
        metadata={
            "help": (
                ...
                "With the same `target_modules`, the number of parameters of LoRA is (2*d*r/n_frequency) times that of QHFT."
                ...
                "'r': 8 in LoRA. At this time, the number of parameters of LoRA is about 16 times that of QHFT."
                "For image classification tasks with Vit-large models, adopting 'n_frequency': 3000 can almost achieve"
                "similar results as 'r': 16 in LoRA, where the number of parameters of LoRA is about 11 times that of QHFT."
            )
        },
    )
    scaling: float = field(
    ...
    target_modules: Optional[Union[list[str], str]] = field(
        ...
        metadata={
            "help": (
                "List of module names or regex expression of the module names to replace with QHFT."
    ...
    exclude_modules: Optional[Union[list[str], str]] = field(
        default=None,
        metadata={"help": "List of module names or regex expression of the module names to exclude from qhft."},
    )
    bias: str = field(
        default="none", metadata={"help": "Bias type for QHFT. Can be 'none', 'all' or 'fourier_only'."}
    )
    ...
    init_weights: bool = field(
        ...
        metadata={
            "help": (
                "The initialization of the QHFT weights. Set this to False if the spectrum should be initialized to a standard normal distribution."
