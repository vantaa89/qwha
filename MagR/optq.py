...
class GPTQ:
    ...
    def __init__(self, layer):
        ...
        self.H = torch.zeros((self.columns, self.columns), device=self.dev) #H:[col, col]
    ...
    def fasterquant(
        self, blocksize=128, percdamp=.01, groupsize=-1, actorder=False, static_groups=False, magr=False, CD_iter=1,
    ):
